...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WETH9 } from '@cytoswap/sdk-core'
import { abi } from '@cytoswap/swap-router-contracts/artifacts/contracts/interfaces/ISwapRouter02.sol/ISwapRouter02.json'
import { Trade as V2Trade } from '@cytoswap/v2-sdk'
import {
  encodeRouteToPath,
  FeeOptions,
  MethodParameters,
...
/**
 * Represents the Cytoswap V2 + V3 SwapRouter02, and has static methods for helping execute trades.
 */
