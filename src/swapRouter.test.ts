import { BigintIsh, CurrencyAmount, Ether, Percent, Token, TradeType, WETH9 } from '@cytoswap/sdk-core'
import { Pair, Route as V2Route, Trade as V2Trade } from '@cytoswap/v2-sdk'
import {
  encodeSqrtRatioX96,
  FeeAmount,
  nearestUsableTick,
