import { Ether, Token, WETH9, CurrencyAmount, Currency } from '@cytoswap/sdk-core'
import { Route as V3RouteSDK, Pool, FeeAmount, TickMath, encodeSqrtRatioX96 } from '@cytoswap/v3-sdk'
import { MixedRoute, RouteV3 } from '../route'
import { Protocol } from '../protocol'
import { Route as V2RouteSDK, Pair } from '@cytoswap/v2-sdk'
